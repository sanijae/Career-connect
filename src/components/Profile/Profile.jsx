    ...
    <>
      <div className='p-2 py-20 m-1 flex justify-center bg-white text-gray-600'>
        <div className='profile'>
          <div className='pro_title  p-3 m-2 md:p-10 md:justify-between rounded-sm shadow-lg'>
            <h1 className='text-5xl'>John Doe</h1>
            <img className='pro_avatar' alt='Profile' src={require('../../Asset/Icons/saj.jpg')}/>
          </div>
          <div className='pro_title m-2 p-3 px-8 flex items-center md:justify-between rounded-sm shadow-lg'>
          ...
          <div className='rounded shadow-lg m-2'>
            ...
            <div className='pro_title m-2 p-3 px-8 flex items-center md:justify-between border-2 border-r-black rounded-md cursor-pointer hover:bg-gray-200'>
              <div className='flex flex-col'>
          ...
          <div className='rounded shadow-lg m-2'>
            ...
            <div className='pro_title p-5 px-8 flex items-center md:justify-between border-b-2 border-gray-400 rounded-md hover:bg-gray-200 cursor-pointer'>
              <div className='flex flex-col'>
            ...
            <div className='pro_title p-5 px-8 flex items-center md:justify-between border-b-2 border-gray-400 rounded-md hover:bg-gray-200 cursor-pointer'>
              <div className='flex flex-col'>
                <h1 className='flex items-center pb-2 text-2xl'> Hide jobs with these details</h1>
